...
\begin{figure}[h]
    \frame{\includegraphics[width=\linewidth]{img/architektur/rechenkomponenten}}
...
\begin{figure}[h]
    \frame{\includegraphics[width=\linewidth]{img/architektur/kopf}}
...
\begin{figure}[h]
    \frame{\includegraphics[width=\linewidth]{img/architektur/vogelperspektive}}
...
\begin{itemize}
    \item \numref{7} Nvidia Jetson Nano 1 ()
    \item \numref{8} Nvidia Jetson Nano 2 ()
    \item \numref{9} Raspberry Pi
\end{itemize}
\todo{Nano, welcher ist wer in port verteilung}
