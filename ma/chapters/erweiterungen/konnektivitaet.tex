...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,caption={[Verbindes des \texttt{wlan2} Interface]}]{listing/connectWlan2.sh}

\noindent Das Skript kann jetzt am Ende des bereits bestehenden Skripts \texttt{configNetwork.sh} aufgerufen werden.

\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=42,lastline=42,firstnumber=42,caption={[Aufrufen des \texttt{connectWlan2.sh} Skripts]}]{listing/configNetwork.sh}
...
\begin{lstlisting}[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstnumber=43]
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,caption={[Modemkonfiguration des \texttt{wwan0} Interfaces]}]{listing/connectWwan0.sh}
