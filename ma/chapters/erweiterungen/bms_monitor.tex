...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=33,lastline=40,firstnumber=33,caption={[Datei \texttt{install.sh} zur BMS-Moniitor Initialisierung]}]{listing/go1-bmsMonitor/install.sh}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=8,lastline=9,firstnumber=8,caption={[Entkopplung des BMS-Monitor durch \texttt{run.sh}]}]{listing/go1-bmsMonitor/bmsMonitor/run.sh}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=13,lastline=23,firstnumber=13,caption={[Dekodierung der binären BMS Daten]}]{listing/go1-bmsMonitor/bmsMonitor/sniff_bms.py}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=14,lastline=16,firstnumber=14,caption={[Konstantes Leuchten der LEDs durch \texttt{const\_led()}]}]{listing/go1-bmsMonitor/bmsMonitor/led_control.py}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=7,lastline=11,firstnumber=7,caption={[Rotes Blinken der LEDs durch \texttt{alert\_led()}]}]{listing/go1-bmsMonitor/bmsMonitor/led_control.py}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,firstline=31,lastline=33,firstnumber=31,caption={[Hinlegen des Hundes im Skript \texttt{sniff\_bms.py}]}]{listing/go1-bmsMonitor/bmsMonitor/sniff_bms.py}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=\dimexpr2.5em-1pt,framexleftmargin=2em,caption={[Konstanten der Python Umgebung des BMS Monitors]}]{listing/go1-bmsMonitor/bmsMonitor/constants.py}
