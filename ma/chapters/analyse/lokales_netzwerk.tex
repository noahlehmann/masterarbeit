...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=2.5em,framexleftmargin=2em,firstline=35,lastline=38,firstnumber=35]{listing/configNetwork.sh}
...
\lstinputlisting[language=Bash,numbers=left,xleftmargin=2.5em,framexleftmargin=2em,firstline=18,lastline=22,firstnumber=18]{listing/hostapd.conf}
