...
\lstinputlisting[language=Bash,firstline=6,lastline=7,numbers=left,xleftmargin=2em,framexleftmargin=1.5em,firstnumber=6,caption={[Inhalt der Autostartdatei \texttt{/home/pi/UnitreeUpgrade/start.sh}]}]{listing/start.sh}
